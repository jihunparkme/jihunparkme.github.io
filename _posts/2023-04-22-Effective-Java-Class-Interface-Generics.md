...
- 비정적 멤버 클래스
  ...
  - 인스턴스를 만들기 위해서는 
    ...
    PublicSample publicSample2 = test.new PublicSample();
    ```
    - 
...
- 익명 클래스
  ...
  - 쓰이는 시점에 선언과 동시에 인스턴스 생성
    ...
    ```
- 지역 클래스
  - 지역번수를 선언할 수 있는 곳이면 실질적으로 어디서든 선언 가능
  - 유효 범위는 지역변수와 동일
